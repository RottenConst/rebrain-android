...
class ProductListViewModel @Inject constructor(
    ...
    private val favoriteRepo: FavoriteProductRepository) :
    ViewModel() {

    private val mProductLiveData: MutableLiveData<List<Product>> = MutableLiveData()
    private val mFavoriteLiveData: MutableLiveData<List<Product>> = MutableLiveData()
    ...
    init {
        ...
        mFavoriteLiveData.value = favoriteRepo.getFavoriteProducts(mProductLiveData.value.orEmpty())
    }
    ...
    fun refreshListFavoriteProduct() {
        mFavoriteLiveData.value = favoriteRepo.getFavoriteProducts(mProductLiveData.value.orEmpty())
    }
}
